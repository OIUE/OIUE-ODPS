...
public class BMO implements IBMO {
	 ...
	 * @return 持久层对象
	 */
	public <T> T getIDMO(String name, String connName, Object... o) {
	 ...
	 * @return 持久层对象
	 */
	public IDMO getIDMOByDsType(String name, String data_type_class, Object... o) {
		IDMO idmo = proxyFactory.getOp().getIDMO(name, data_type_class, o);
		return idmo;
	}
	 ...
	 *             异常
	 */
	public IBMO getIBMO(String name, Object... o) throws Throwable {
		IBMO ibmo;
